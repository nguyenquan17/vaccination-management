...
import ToolBarReportsManagement from "./ToolBarReportsManagement";
...
function ReportsManagementTable(props) {
    ...
    return (
        <div style={{height: 700, width: '100%'}}>
            <DataGrid
                components={{Toolbar: ToolBarReportsManagement}}
                rows={rows}
                columns={columns}
                sortModel={sortModel}
...
export default connect(mapStateToProps, mapDispatchToProps)(ReportsManagementTable);